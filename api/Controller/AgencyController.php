...
class AgencyController extends AppController {
	...
	public function index () {
		...
		$this->Agency->virtualFields['rating'] = "SELECT ROUND(AVG(`rate`), 2) FROM `nurse_maid_ratings` WHERE `nurse_maid_ratings`.`agency_id` = `Agency`.`id`";
	...
	public function detail () {
		...
		$this->Agency->virtualFields['rating_count'] = "SELECT ROUND(COUNT(`rate`), 2) FROM `nurse_maid_ratings` WHERE `nurse_maid_ratings`.`agency_id` = `Agency`.`id`";
