...
class MobileDetect
{
    ...
    protected static $phoneDevices = array(
       ...
       'iMobile'        => 'i-mobile (IQ|i-STYLE|idea|ZAA|Hitz)',
        ...
        'Kindle'        => 'Android.*KFAUWI|Kindle|Silk*|Silk.Accelerated|Android.\b(KFOT|KFTT|KFJWI|KFJWA|KFOTE|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|WFJWAE|KFSAWA|KFSAWI|KFASWI|KFARWI|KFAUWI)\b'
    );
